...
class Product(models.Model):
    ...
    pack_image_transparent = models.URLField(blank=True, default='')
    ingredient_image = models.URLField()
    ingredient_image_transparent = models.URLField(blank=True, default='')
    bg_removal_status = models.CharField(max_length=20, default='completed')
