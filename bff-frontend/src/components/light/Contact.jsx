...
export default function Contact({ hideHeader = false }) {
  ...
  const t = isDark ? {
    ...
    heading2:    '#f0f4ff',
    green:       '#4ade80',
    lightGrey:   'rgba(255,255,255,0.03)',
  } : {
    sectionBg:   'var(--light-grey)',
    cardBg:      'white',
    ...
    inputFocus:  'var(--green)',
    inputColor:  'var(--text-dark)',
    selectBg:    'white',
    labelDark:   'var(--text-body)',
    sectionLabel:'var(--text-muted)',
    heading2:    'var(--text-dark)',
    green:       'var(--green)',
  ...
  return (
    <section
      id="contact"
      ref={containerRef}
      className={isDark ? '' : 'section'}
      style={{
        background: t.sectionBg,
        overflow: 'hidden',
        padding: isDark ? 'clamp(80px, 10vw, 160px) 0' : undefined,
        // Dark mode CSS variable overrides so child elements using var(--xxx) get the right values
        ...(isDark ? {
          '--white':        '#1a2035',
          '--light-grey':   '#111827',
    ...
    >
      <div
        className={isDark ? '' : 'container'}
        style={isDark ? { maxWidth: '1400px', margin: '0 auto', padding: '0 clamp(20px, 5vw, 80px)' } : {}}
      >
        {/* Header */}
        {!hideHeader && (
          <div ref={headerRef} style={{ textAlign: 'center', marginBottom: '64px' }}>
            <div className="section-label" style={{ display: 'inline-block', marginBottom: '16px', color: t.textMuted, fontFamily: 'var(--font-display)', fontSize: '11px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' }}>Get in Touch</div>
            <h2 className="display-md" style={{ color: t.textDark, marginBottom: '16px', fontFamily: 'var(--font-display)', fontWeight: 800 }}>
              Let&apos;s Work{' '}
              <span className={isDark ? '' : 'gradient-text-green'} style={isDark ? { background: 'linear-gradient(135deg, #4ade80 0%, #86efac 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' } : {}}>Together.</span>
            </h2>
            <p className="body-lg" style={{ color: t.textBody, maxWidth: '480px', margin: '0 auto', fontFamily: 'var(--font-body)' }}>
        ...
        <div style={{
          ...
          <div ref={formRef} style={{
            ...
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '40px 0' }}>
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '24px', color: t.green }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', color: t.textBody, lineHeight: 1.7 }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <select
                    ...
                    style={{ cursor: 'pointer', width: '100%', padding: '12px 14px', borderRadius: 'var(--radius-sm)', border: `1px solid ${t.inputBorder}`, background: t.selectBg, color: t.inputColor, fontFamily: 'var(--font-body)' }}
                  >
          ...
          <div ref={cardsRef} style={{
            ...
            <div style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = t.green; e.currentTarget.style.boxShadow = 'var(--shadow-md)'; }}
